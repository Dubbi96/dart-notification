...
import { EditionPushModule } from './edition-push/edition-push.module';
 ...
 */
@Module({
  imports: [MarketDataModule, IndicatorsModule, EventStudyModule, BuySignalModule, BacktestModule, SignalGenerationModule, PriceMoveAlertModule, EditionPushModule, PrismaModule],
  ...
  exports: [MarketDataModule, IndicatorsModule, EventStudyModule, BuySignalModule, BacktestModule, SignalGenerationModule, PriceMoveAlertModule, EditionPushModule],
})
