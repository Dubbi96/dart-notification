...
| 구분 | critical | high | moderate | 허용 advisory | 차단 advisory |
|---|---:|---:|---:|---:|---:|
| 변경 전 | 1 | 12 | 13 | 25 | 6 |
| 변경 후 | 0 | 8 | 13 | 19 | 0 |

변경 전 차단 항목은 `adm-zip` 1건, `brace-expansion` 2건, `js-yaml` 1건, `tar` 2건이었다. 기존 allowlist에 있던 과거 `tar` 6건도 의존 체인 제거와 함께 해소했다.
