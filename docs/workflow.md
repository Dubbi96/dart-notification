...
- **딥링크**: 신호탭 에디션 브라우징(`/signals`, 모바일 화이트리스트 통과). 정밀 딥링크(에디션 호 지정)+놓친 호 뱃지는 Wave B P1 후속.
