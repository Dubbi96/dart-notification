 ...
 * ★정직: 데이터는 '실제 시장 시각' 기준이며, 앱 환경 시계와 어긋날 수 있음을 고지한다.
 */
  ...
  return (
    <View style={styles.wrap}>
      ...
      {n >= 2 ? (
        <Text
          accessibilityRole="text"
          accessibilityLabel="캔들을 탭하면 해당 시각의 시·고·저·종과 거래량을 볼 수 있습니다."
          style={[typo.small, { color: colors.textTertiary, marginTop: spacing.xs }]}
        >
          캔들을 탭하면 해당 시각의 가격·거래량을 볼 수 있어요.
        </Text>
      ) : null}
    </View>
  );
