...
// DAR-312: 반올림 후 0 이면 부호 제거(음수영점 -0.0% 차단). 양수영점도 대칭으로 '+' 제거 →
// 0.004 는 표기상 0.00% 이므로 '+0.00%' 가 아니라 부호 없는 '0.00%' 가 일관 규칙이다.
check('+0.004 → 반올림 0 이라 부호 없는 0.00%', chartPath(0.004), '0.00%');
check('-0 → 부호 없는 0.00%', chartPath(-0), '0.00%');
